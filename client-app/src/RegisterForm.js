        ...
        <div>
            <div className='formBoxRegister'>
                <form>
                    ...
                    <select className='genSelect' id="gen" onChange={(evt) => setGen(evt.target.value)}>
                        <option className='genOption' id="optionF" value={"F"}>F</option>
                        <option className='genOption' id="optionM" value={"M"}>M</option>
                    </select>
